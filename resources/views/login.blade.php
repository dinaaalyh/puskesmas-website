...
<head>
    ...
    <title>/ Login - Puskesmas Kalijaga</title>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="index.html" class="logo d-flex align-items-center w-auto">
                                    ...
                                    <span class="d-none d-lg-block">PUSKESMAS KALIJAGA</span>
                                </a>
                            </div><!-- End Logo -->
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4"> ADMIN PUSKESMAS Silakan Login
                                        </h5>
                                    ...
                                    @if ($errors->any())
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex flex-column pe-0 pe-sm-10">
                                                <!--begin::Title-->
                                                <h5 class="mb-3">Oops! Terjadi Kesalahan</h5>
                                                <!--end::Title-->
                                                <!--begin::Content-->
                                                <ul>
                            ...
                            <div class="credits">
                                ...
                                Designed by <a href="https://bootstrapmade.com/">PUSKESMAS</a>
                            </div>

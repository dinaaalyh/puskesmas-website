<body onload="javascript:window.print()" style="margin:0 auto; width: 1000px;">
    ...
    <table width="90%" cellpadding="0" cellpading="0">
        <tr>
            ...
            <td>
                <div align="center">
                    <font size="20"> CETAK DATA POLITEKNIKN</forn>
                        <font size="5">
    ...
    <hr>
    <label>
        <font size="5">DATA POLITEKNIK</font>
    </label>
    <br></br>
    <table style="border: 1px solid gray;" width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <th style="border-right: 1px solid grey;"> No.</th>
            <th align="center" style="border-right: 1px solid grey;">Kode</td>
            <th align="center" style="border-right: 1px solid grey;">Nama Poliklinik</td>
        </tr>
